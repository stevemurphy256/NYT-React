    ...
    return (
      ...
      <div className="container" style={ {backgroundColor: "white", borderStyle: "solid", borderWidth: "1px"} }>
        ...
        <div className="page-header">
          ...
          <h2 className="text-center" style={ {marginTop: "-12px"} }><b><i>In the React World</i></b></h2>
          <h4 className="text-center">Search for any articles that interest you. Click on headlines to view full article.</h4>
        </div>
